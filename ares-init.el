...
(defun load-and-run-fave-file()
  (interactive)
   (find-file "~/projects/autostall/conman/test/test.scm")
;;   (find-file "~/projects/autostall/conman/test/utilities.scm")
;;   (find-file "~/projects/autostall/conman/test/ollama.scm")  
  (sesman-start)
  )
